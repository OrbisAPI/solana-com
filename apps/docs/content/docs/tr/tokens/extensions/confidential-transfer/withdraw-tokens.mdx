...
Gizli kullanılabilir bakiyeden token'ları genel bakiyeye çekmek için:
...
1. İstemci tarafında
   ...
   **Eşitlik Kanıtı
   ...
   Çekim sonrasında kalan kullanılabilir bakiye şifreli metninin, karşılık gelen
   ...
   **Aralık Kanıtı
   ...
   Çekim sonrasında kalan kullanılabilir bakiyenin negatif olmadığını ve
   belirtilen bir aralık içinde olduğunu doğrular.

2. Her kanıt için:
   - Kanıt verilerini doğrulamak üzere ZK ElGamal kanıt programını çağırın.
   - Diğer talimatlardan yararlanmak için kanıta özgü meta verileri bir kanıt
...
4. Bunları oluşturmak için kullanılan SOL'u geri kazanmak amacıyla kanıt
   hesaplarını kapatın.
...
Gizli kullanılabilir bakiyeden token'ları genel bakiyeye çekmek için şunları
yapmalısınız:
...
Aşağıdaki örnek, gizli kullanılabilir bakiyeden genel bakiyeye token çekmenin
