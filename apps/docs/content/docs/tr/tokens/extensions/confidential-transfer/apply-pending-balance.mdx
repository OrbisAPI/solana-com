...
## Bekleyen bakiye kullanılabilir bakiyeye nasıl uygulanır

Tokenlar gizli olarak transfer edilebilmeden önce, genel token bakiyesinin gizli
...
2. **Gizli Kullanılabilir Bakiye**: Bekleyen bakiye daha sonra kullanılabilir
   bakiyeye "uygulanır" ve tokenlar gizli transferler için kullanılabilir hale
   gelir.

Bu bölüm ikinci aşamayı açıklar: bekleyen bakiyenin kullanılabilir bakiyeye
uygulanması.

Tokenlar genel bakiyeden "yatırıldığında" veya bir token account'tan diğerine
gizli olarak transfer edildiğinde, tokenlar başlangıçta gizli bekleyen bakiyeye
eklenir. Tokenlar gizli transferler için kullanılabilmeden önce, bekleyen
...
Aşağıdaki diyagram, bekleyen bakiyenin kullanılabilir bakiyeye uygulanmasında
yer alan adımları göstermektedir:
...
başlatmak için Solana CLI'nin kurulu olması gerekmektedir.
...
<Callout type="info">
  Bu yazının hazırlandığı sırada, Gizli Transferler varsayılan yerel
