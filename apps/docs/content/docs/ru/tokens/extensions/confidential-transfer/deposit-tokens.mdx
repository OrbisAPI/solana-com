...
1. **Конфиденциальный ожидающий баланс**: Сначала токены «вносятся» из
...
В этом разделе описывается первый этап: внесение публичного баланса токенов на
конфиденциальный ожидающий баланс.

Следующая диаграмма показывает шаги, необходимые для внесения токенов из
...
<Callout type="info">
  На момент написания Конфиденциальные переводы не включены в локальном
  validator по умолчанию. Для запуска примера кода необходимо клонировать Token
  Extensions Program из мейннета.
</Callout>
