...
Cette section explique la première étape : le dépôt du solde de tokens public
vers le solde en attente confidentiel.

Le diagramme suivant illustre les étapes de dépôt des tokens depuis le solde
...
Pour convertir un solde public en solde en attente confidentiel, invoquez l'
instruction
...
L'exemple suivant montre comment déposer un solde de tokens public vers un solde
