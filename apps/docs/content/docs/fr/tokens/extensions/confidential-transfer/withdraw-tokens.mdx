...
1. Créez
   ...
   **Preuve de plage
   ...
   compris dans une plage spécifiée.
...
Le diagramme suivant illustre les étapes du retrait de tokens du solde
...
L'exemple suivant montre comment retirer des tokens du solde disponible
confidentiel vers le solde public.
...
avoir le CLI Solana installé pour démarrer le validator local.
