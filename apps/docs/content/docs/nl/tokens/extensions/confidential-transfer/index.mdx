...
- [Snelstartgids](https://www.solana-program.com/docs/confidential-balances#setup) -
  Instelling en basale CLI-opdrachten
...
4. **Stort** het publieke saldo van de verzender naar het **vertrouwelijk
   uitstaand saldo**.
5. **Verwerk** het uitstaande saldo van de verzender naar het **vertrouwelijk
   beschikbaar saldo**.
6. **Draag** tokens vertrouwelijk over van het token account van de verzender
   naar het token account van de ontvanger.
7. **Verwerk** het uitstaande saldo van de ontvanger naar het **vertrouwelijk
   beschikbaar saldo**.
8. **Onttrek** het vertrouwelijk beschikbare saldo van de ontvanger naar het
   **publieke saldo**.

Voor meer details over de stappen in de vertrouwelijke overdrachtstroom, zie de
...
<Cards>
  ...
  >
    Een mint account aanmaken met de Confidential Transfer-extensie
  </Card>
  <Card
    title="Token Account Aanmaken"
    href="/docs/tokens/extensions/confidential-transfer/create-token-account"
  >
    Een token account configureren met de Confidential Transfer-extensie
  </Card>
  <Card
    title="Tokens Storten"
    href="/docs/tokens/extensions/confidential-transfer/deposit-tokens"
  >
    Tokens storten naar het vertrouwelijk uitstaand saldo
  </Card>
  <Card
    title="Uitstaand Saldo Verwerken"
    href="/docs/tokens/extensions/confidential-transfer/apply-pending-balance"
  >
    Uitstaand saldo verwerken naar het beschikbare vertrouwelijke saldo
  </Card>
  <Card
    title="Tokens Onttrekken"
    href="/docs/tokens/extensions/confidential-transfer/withdraw-tokens"
  >
    Tokens onttrekken uit het vertrouwelijk beschikbaar saldo
  </Card>
  <Card
    title="Tokens Overdragen"
    href="/docs/tokens/extensions/confidential-transfer/transfer-tokens"
  >
    Tokens vertrouwelijk overdragen tussen token accounts
  </Card>
  <Card
    title="Integratiegids"
    href="/docs/tokens/extensions/confidential-transfer/integration-guide"
  >
    Hoe wallets, explorers en exchanges vertrouwelijke overdrachtstokens kunnen
    ondersteunen
  </Card>
  <Card
    title="Uitgevers­gids"
    href="/docs/tokens/extensions/confidential-transfer/issuer-guide"
  >
    Een vertrouwelijk overdrachtstoken uitgeven en beheren (goedkeuringsbeleid,
    auditors, kosten, mint en burn)
  </Card>
</Cards>
...
voor de duidelijkheid opgesplitst in helperfuncties.

Om het voorbeeld uit te voeren, start u een lokale validator met het Token
Extensions Program gekloond van mainnet met behulp van de volgende opdracht. U
moet de Solana CLI geïnstalleerd hebben om de lokale validator te kunnen
gebruiken.
...
<Callout type="info">
  ...
  standaard lokale validator. U moet het mainnet Token Extensions Program klonen
...
## Instructies voor Vertrouwelijke Overdracht

De volledige lijst met Confidential Transfer-extensie
[instructies](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/instruction.rs#L29)
zijn als volgt:

| Instructie                          | Beschrijving                                                                                                                                                                       |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`InitializeMint`_                | Configureert mint account voor vertrouwelijke overdrachten. Deze instructie moet worden opgenomen in dezelfde transactie als de instructie _rs`TokenInstruction::InitializeMint`_. |
...
| _rs`EnableNonConfidentialCredits`_  | Staat een token account toe om publieke tokenoverdrachten te ontvangen.                                                                                                            |
...
| _rs`ConfigureAccountWithRegistry`_  | Alternatieve manier om token accounts te configureren voor vertrouwelijke overdrachten met een _rs`ElGamalRegistry`_ account in plaats van _rs`VerifyPubkeyValidity`_ bewijs.      |
