...
## Hoe tokens te storten naar het vertrouwelijke wachtende saldo

Voordat tokens vertrouwelijk kunnen worden overgedragen, moet het openbare
tokensaldo worden omgezet naar een vertrouwelijk saldo. Deze conversie verloopt
in twee fasen:

1. **Vertrouwelijk Wachtend Saldo**: Aanvankelijk worden tokens "gestort" van
   het openbare saldo naar een "wachtend" vertrouwelijk saldo.
...
openbare saldo naar het vertrouwelijke wachtende saldo:
...
Het volgende voorbeeld demonstreert hoe het openbare tokensaldo wordt gestort
naar het vertrouwelijke wachtende saldo.
