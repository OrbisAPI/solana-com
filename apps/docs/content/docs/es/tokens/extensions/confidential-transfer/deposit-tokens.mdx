...
Para convertir un saldo público a un saldo pendiente confidencial, invoca la
instrucción
...
instrucción `Deposit`, como se muestra en el ejemplo a continuación.

### Código de Ejemplo

El siguiente ejemplo muestra cómo depositar el saldo público de tokens en el
...
<Callout type="info">
  En el momento de redactar esto, las Transferencias Confidenciales no están
