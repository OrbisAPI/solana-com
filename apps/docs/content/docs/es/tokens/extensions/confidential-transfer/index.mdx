...
1. Crea un mint account con la extensión de transferencia confidencial.
...
5. **Aplica** el saldo pendiente del emisor al **saldo disponible
   confidencial**.
6. **Transfiere** confidencialmente los tokens desde la token account del emisor
...
<Cards>
  ...
  >
    Cómo crear un mint account con la extensión de transferencia confidencial
  </Card>
  <Card
  ...
  >
    Cómo aplicar el saldo pendiente al saldo disponible confidencial
  </Card>
  <Card
...
El ejemplo en Rust a continuación muestra los pasos para transferencias de
tokens confidenciales correspondientes al diagrama anterior. Los pasos están
...
Solana instalada para usar el validator local.
