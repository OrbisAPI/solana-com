...
1. Luo
   ...
   **Yhtäläisyystodiste
   ...
   Varmistaa, että uuden käytettävissä olevan saldon salateksti siirron jälkeen
   vastaa vastaavaa
   [Pedersen-sitoumustaan](https://en.wikipedia.org/wiki/Commitment_scheme),
   ...
   **Salatekstin voimassaolotodiste
   ...
   Varmistaa, että siirtobeträgin salatekstit on asianmukaisesti luotu kaikille
   kolmelle osapuolelle (lähde, kohde ja tarkastaja), varmistaen, että
   siirtosumma on oikein salattu kunkin osapuolen julkisella avaimella.
   ...
   **Aluetodiste
   ...
   Varmistaa, että uusi käytettävissä oleva saldo ja siirtosumma (jaettu
   mataliin/korkeisiin bitteihin) ovat ei-negatiivisia ja määritetyn alueen
   sisällä.

2. Kutakin todistetta varten:
   - Kutsu ZK ElGamal -todisteohjelma todistetietojen varmentamiseksi.
...
3. Kutsu
   ...
   -ohje antamalla todisteen kontekstitilit.

4. Sulje todisteen kontekstitilit palauttaaksesi niiden luomiseen käytetyn
   SOL:n.

Seuraava kaavio näyttää vaiheet, jotka liittyvät tokeneiden siirtämiseen
...
- Luoda yhtäläisyystodiste, salatekstin voimassaolotodiste ja aluetodiste
  asiakaspuolella
- Kutsua Zk ElGamal -todisteohjelma todisteiden varmentamiseksi ja
  "kontekstitila"-tilien alustamiseksi
- Kutsua
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
  -ohje antamalla kolme todistetilin.
- Sulkea kolme todistetilin palauttaaksesi rent.
...
Seuraava esimerkki havainnollistaa, kuinka tokeneita siirretään
luottamuksellisesti token account -tilien välillä.

Esimerkin suorittamista varten käynnistä paikallinen validator, johon on
kloonattu Token Extensions Program mainnetistä, käyttämällä alla olevaa
komentoa. Sinulla täytyy olla Solana CLI asennettuna paikallisen validatorin
käynnistämiseksi.
...
<Callout type="info">
  ...
  validatorissa. Sinun täytyy kloonata mainnetin Token Extension Program
