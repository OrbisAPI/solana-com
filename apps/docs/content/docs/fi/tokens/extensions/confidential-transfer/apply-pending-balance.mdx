...
## Kuinka ottaa käyttöön odottava saldo käytettävissä olevaan saldoon
...
2. **Luottamuksellinen käytettävissä oleva saldo**: Odottava saldo "otetaan
   käyttöön" käytettävissä olevaan saldoon, jolloin tokenit ovat käytettävissä
   luottamuksellisiin siirtoihin.

Tässä osiossa selitetään toinen vaihe: odottavan saldon ottaminen käyttöön
käytettävissä olevaan saldoon.

Kun tokenit "talletetaan" julkisesta saldosta tai kun tokenit siirretään
luottamuksellisesti yhdestä token account -tilistä toiseen, tokenit lisätään
aluksi luottamukselliseen odottavaan saldoon. Ennen kuin tokeneita voidaan
käyttää luottamuksellisiin siirtoihin, odottava saldo täytyy "ottaa käyttöön"
käytettävissä olevaan saldoon.
...
Seuraava kaavio näyttää vaiheet, jotka liittyvät odottavan saldon ottamiseen
käyttöön käytettävissä olevaan saldoon:
...
lähettää tapahtuman `ApplyPendingBalance` -ohjeella, kuten alla olevassa
esimerkissä on esitetty.

### Esimerkkikoodi

Seuraava esimerkki havainnollistaa, kuinka luottamuksellinen odottava saldo
otetaan käyttöön luottamukselliseen käytettävissä olevaan saldoon.

Ajaksesi esimerkin, käynnistä paikallinen validator Token Extension Program
-ohjelman kanssa, joka on kloonattu mainnetistä seuraavalla komennolla. Sinulla
...
<Callout type="info">
  ...
  oletuspaikallisessa validatorissa. Sinun täytyy kloonata mainnet Token
  Extension Program ajaksesi esimerkkikoodin.
</Callout>
