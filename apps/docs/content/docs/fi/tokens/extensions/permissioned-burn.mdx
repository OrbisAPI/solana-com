...
devnetistä testi-validatoriisi:
...
Luo mint luvallisella poltolla ja polta tokeneita:
...
5. Poista halutessasi luvallinen polttaminen käytöstä
   _rs`SetAuthority`_-komennolla käyttäen
   _rs`AuthorityType::PermissionedBurn`_-komentoa ja `None`-valtuutusta, mikä
   ottaa tavalliset poltto-ohjeet uudelleen käyttöön. Alla olevat täydelliset
...
Laske rent käyttäen mintille ja _rs`PermissionedBurnConfig`_-laajennukselle
tarvittavaa kokoa.
...
Alusta _rs`PermissionedBurnConfig`_-laajennus mintille polttovaltuutuksella.
...
Luo payer-tilille token account ja lyö sille tokeneja.
...
## !!steps Polta burn authorityllä

Polta tokeneita _rs`PermissionedBurnInstruction::BurnChecked`_:lla, jonka ovat
allekirjoittaneet sekä token account -omistaja että burn authority.
...
<Callout type="info" title="Instruction Order">
  ...
  _rs`InitializeMint`_:ää. _rs`CreateAccount`_,
...
| Kohde                                          | Kuvaus                                                                                                                            | Lähde                                                                                                                                         |
| ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| _rs`PermissionedBurnConfig`_                   | Mint-laajennus, joka tallentaa auktoriteetin, joka vaaditaan allekirjoittamaan jokainen poltto mintille.                          | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/interface/src/extension/permissioned_burn/mod.rs#L16-L25)         |
| _rs`PermissionedBurnInstruction::Initialize`_  | Ohje, joka alustaa permissioned burn -konfiguraation ennen _rs`InitializeMint`_:ää.                                               | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/interface/src/extension/permissioned_burn/instruction.rs#L41-L49) |
| _rs`PermissionedBurnInstruction::Burn`_        | Poltto-ohje, joka vaatii allekirjoitukset burn authoritylta sekä token account -omistajalta tai -valtuutetulta.                   | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/interface/src/extension/permissioned_burn/instruction.rs#L50-L71) |
...
| _rs`AuthorityType::PermissionedBurn`_          | Auktoriteetin erotin, jota käytetään _rs`SetAuthority`_:n kanssa burn authorityn kiertämiseen tai poistamiseen käytöstä mintiltä. | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/interface/src/instruction.rs#L1276-L1277)                         |
| _rs`process_initialize`_                       | Prosessorilogiikka, joka alustaa _rs`PermissionedBurnConfig`_:n alustamattomalle mintille ja tallentaa burn authorityn.           | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/program/src/extension/permissioned_burn/processor.rs#L29-L47)     |
| _rs`process_burn`_                             | Prosessorilogiikka, joka hylkää tavanomaiset poltot, kun burn authority on asetettu, ja tarkistaa auktoriteetin allekirjoituksen. | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/program/src/processor.rs#L1114-L1179)                             |
| _rs`process_set_authority`_                    | Prosessorilogiikka, joka validoi ja kiertää burn authorityn, kun _rs`AuthorityType::PermissionedBurn`_:ää käytetään.              | [Lähde](https://github.com/solana-program/token-2022/blob/program%40v11.0.0/program/src/processor.rs#L996-L1008)                              |

### Typescript

Alla oleva `Kit` esimerkki käyttää generoituja ohjeita suoraan. Julkaistu
perintö `@solana/spl-token` -paketti ei vielä sisällä lupapohjaista
poltto-tukea, joten perintöesimerkkiä ei ole sisällytetty.
