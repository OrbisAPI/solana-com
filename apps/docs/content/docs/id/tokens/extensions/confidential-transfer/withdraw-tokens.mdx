...
1. Buat
   ...
   **Bukti Kesetaraan
   ...
   bersesuaian, memastikan saldo tersedia baru akun dihitung dengan benar
...
3. Panggil instruksi
   ...
   dengan menyertakan dua akun bukti.
...
Contoh berikut mendemonstrasikan cara menarik token dari saldo tersedia rahasia
ke saldo publik.
