...
dikonversi ke saldo rahasia. Konversi ini berlangsung dalam dua tahap:
...
2. **Saldo Tersedia Rahasia**: Saldo tertunda kemudian "diterapkan" ke saldo
   tersedia, sehingga token siap digunakan untuk transfer rahasia.
...
Untuk mengonversi saldo tertunda ke saldo tersedia, panggil instruksi
...
`confidential_transfer_apply_pending_balance` yang membangun dan mengirimkan
...
yang di-clone dari mainnet menggunakan perintah berikut. Anda harus memiliki
