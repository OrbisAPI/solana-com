...
Alur dasar confidential token transfers adalah sebagai berikut:
...
Untuk detail lebih lanjut mengenai langkah-langkah dalam alur confidential
...
<Cards>
  ...
  >
    Cara mendepositkan token ke confidential pending balance
  </Card>
  <Card
    title="Terapkan Pending Balance"
    href="/docs/tokens/extensions/confidential-transfer/apply-pending-balance"
  >
    Cara menerapkan pending balance ke confidential available balance
  </Card>
  <Card
    title="Withdraw Token"
    href="/docs/tokens/extensions/confidential-transfer/withdraw-tokens"
  >
    Cara menarik token dari confidential available balance
  </Card>
  <Card
...
dipisahkan ke dalam fungsi pembantu untuk kejelasan.
...
menginstal Solana CLI untuk menggunakan validator lokal.
...
| _rs`UpdateMint`_                    | Memperbarui pengaturan confidential transfer untuk sebuah mint.                                                                                                      |
