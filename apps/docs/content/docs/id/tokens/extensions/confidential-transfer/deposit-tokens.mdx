...
dikonversi ke saldo rahasia. Konversi ini terjadi dalam dua tahap:
...
2. **Saldo Tersedia Rahasia**: Saldo tertunda kemudian "diterapkan" ke saldo
   tersedia, sehingga token tersedia untuk transfer rahasia.
...
dari saldo publik ke saldo tertunda rahasia:
...
Untuk mengonversi saldo publik ke saldo tertunda rahasia, panggil instruksi
