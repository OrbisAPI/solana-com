...
Перш ніж токени можна буде переказати конфіденційно, публічний баланс токенів
необхідно перетворити на конфіденційний баланс. Це перетворення відбувається у
два етапи:
...
У цьому розділі пояснюється другий етап: застосування відкладеного балансу до
доступного балансу.

Коли токени «депонуються» з публічного балансу або конфіденційно переказуються з
одного token account на інший, вони спочатку додаються до конфіденційного
відкладеного балансу. Перш ніж токени можна буде використовувати для
конфіденційних переказів, відкладений баланс необхідно «застосувати» до
доступного балансу.
...
Наведена нижче діаграма показує кроки, що виконуються під час застосування
відкладеного балансу до доступного балансу:
...
Щоб перетворити відкладений баланс на доступний, викличте інструкцію
...
`confidential_transfer_apply_pending_balance`, який формує та надсилає
...
клонованою з mainnet, використовуючи наведену нижче команду. Для запуску
...
<Callout type="info">
  На момент написання цього матеріалу, Confidential Transfers не підтримувалися
  у локальному validator за замовчуванням. Щоб запустити приклад коду, необхідно
