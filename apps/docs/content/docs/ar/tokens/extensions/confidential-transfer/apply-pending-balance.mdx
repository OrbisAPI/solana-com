...
المعلق. قبل أن تتمكن الرموز من الاستخدام في التحويلات السرية، يجب "تطبيق" الرصيد
المعلق على الرصيد المتاح.
...
يوضح الرسم البياني التالي الخطوات المتبعة في تطبيق الرصيد المعلق على الرصيد
المتاح:
...
لتحويل رصيد معلق إلى رصيد متاح، استدعِ تعليمة
...
يوفر crate `spl_token_client` طريقة
...
<Callout type="info">
  في وقت كتابة هذه السطور، لم يتم تمكين التحويلات السرية على validator المحلي
  الافتراضي. يجب عليك استنساخ Token Extensions Program من الشبكة الرئيسية لتشغيل
  كود المثال.
</Callout>
