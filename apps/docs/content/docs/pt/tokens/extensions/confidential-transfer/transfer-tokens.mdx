...
1. Crie
   ...
   **Prova de Igualdade
   ...
   seja corretamente calculado como
   ...
   **Prova de Validade do Texto Cifrado
   ...
   garantindo que o valor da transferência seja corretamente cifrado sob a chave
...
O exemplo a seguir demonstra como transferir tokens de forma confidencial entre
token accounts.
...
<Callout type="info">
  ...
  estão habilitadas no validator local padrão. Você deve clonar o Token
