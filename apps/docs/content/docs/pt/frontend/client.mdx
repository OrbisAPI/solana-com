...
<Callout type="info">
  ...
  no navegador? Assine com um serviço de gerenciamento de chaves de backend em
  vez de um keypair bruto. Consulte [Keychain](/docs/tools/keychain) e
...
- **Testabilidade**: A interface de cliente única pode ser mockada em testes
