...
1. Δημιουργήστε
   ...
   **Απόδειξη Ισότητας
   ...
   Επαληθεύει ότι το εναπομείναν κρυπτοκείμενο διαθέσιμου υπολοίπου μετά την
   ανάληψη αντιστοιχεί στο
   [δέσμευμα Pedersen](https://en.wikipedia.org/wiki/Commitment_scheme),
...
- Δημιουργήστε απόδειξη ισότητας και απόδειξη εύρους στην πλευρά του πελάτη
- Καλέστε το πρόγραμμα αποδείξεων Zk ElGamal για να επαληθεύσετε τις αποδείξεις
...
Η βιβλιοθήκη `spl_token_client` παρέχει τις ακόλουθες μεθόδους:
...
Το παρακάτω παράδειγμα δείχνει πώς να αποσύρετε tokens από το εμπιστευτικό
