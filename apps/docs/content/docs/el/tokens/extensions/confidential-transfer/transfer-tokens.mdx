...
## Πώς να μεταφέρετε tokens εμπιστευτικά από έναν token account σε έναν άλλο

Για να μεταφέρετε tokens εμπιστευτικά από έναν token account σε έναν άλλο, τόσο
ο αποστολέας όσο και ο παραλήπτης πρέπει να έχουν token accounts διαμορφωμένους
με την κατάσταση _rs`ConfidentialTransferAccount`_ και εγκεκριμένους για
εμπιστευτικές μεταφορές. Ο token account του αποστολέα πρέπει επίσης να διαθέτει
...
1. Δημιουργήστε
   ...
   **Απόδειξη Ισότητας
   ...
   αντιστοιχεί, διασφαλίζοντας ότι το νέο διαθέσιμο υπόλοιπο του λογαριασμού
   προέλευσης υπολογίζεται σωστά ως
   ...
   **Απόδειξη Εγκυρότητας Ciphertext
   ...
   μεταφοράς κρυπτογραφείται σωστά με το δημόσιο κλειδί κάθε μέρους.
...
2. Για κάθε απόδειξη:
   - Καλέστε το πρόγραμμα αποδείξεων ZK ElGamal για να επαληθεύσετε τα δεδομένα
     της απόδειξης.
...
Το παρακάτω διάγραμμα δείχνει τα βήματα που απαιτούνται για τη μεταφορά tokens
από τον token account ενός αποστολέα στον token account ενός παραλήπτη.
...
Για να μεταφέρετε tokens εμπιστευτικά από έναν token account σε έναν άλλο,
πρέπει:

- Να δημιουργήσετε απόδειξη ισότητας, απόδειξη εγκυρότητας ciphertext και
  απόδειξη εύρους στην πλευρά του client
- Να καλέσετε το πρόγραμμα αποδείξεων Zk ElGamal για να επαληθεύσετε τις
  αποδείξεις και να αρχικοποιήσετε τους λογαριασμούς «context state»
- Να καλέσετε την εντολή
  [ConfidentialTransferInstruction::Transfer](https://github.com/solana-program/token-2022/blob/efd0c957fefbd79882d77df5fb2dac88c001249c/program/src/extension/confidential_transfer/processor.rs#L604)
  παρέχοντας τους τρεις λογαριασμούς απόδειξης.
- Να κλείσετε τους τρεις λογαριασμούς απόδειξης για να ανακτήσετε το rent.
...
<Callout type="info">
  Κατά τη στιγμή της συγγραφής, τα Confidential Transfers δεν είναι
  ενεργοποιημένα στον προεπιλεγμένο τοπικό validator. Πρέπει να κλωνοποιήσετε το
  mainnet Token Extension Program για να εκτελέσετε τον κώδικα του
  παραδείγματος.
</Callout>
