...
Πριν από τη μεταφορά tokens με εμπιστευτικό τρόπο, το δημόσιο υπόλοιπο tokens
πρέπει να μετατραπεί σε εμπιστευτικό υπόλοιπο. Η μετατροπή αυτή πραγματοποιείται
σε δύο στάδια:
...
2. **Εμπιστευτικό Διαθέσιμο Υπόλοιπο**: Στη συνέχεια, το εκκρεμές υπόλοιπο
   «εφαρμόζεται» στο διαθέσιμο υπόλοιπο, καθιστώντας τα tokens διαθέσιμα για
   εμπιστευτικές μεταφορές.

Αυτή η ενότητα εξηγεί το πρώτο στάδιο: κατάθεση του δημόσιου υπολοίπου tokens
στο εμπιστευτικό εκκρεμές υπόλοιπο.
...
Το παρακάτω παράδειγμα δείχνει πώς να καταθέσετε το δημόσιο υπόλοιπο tokens στο
...
εντολή. Πρέπει να έχετε εγκαταστήσει το Solana CLI για να εκκινήσετε τον τοπικό
validator.
...
<Callout type="info">
  Κατά τη στιγμή της σύνταξης, οι Εμπιστευτικές Μεταφορές δεν είναι
  ενεργοποιημένες στον προεπιλεγμένο τοπικό validator. Πρέπει να κλωνοποιήσετε
  το mainnet Token Extensions Program για να εκτελέσετε τον κώδικα του
  παραδείγματος.
</Callout>
