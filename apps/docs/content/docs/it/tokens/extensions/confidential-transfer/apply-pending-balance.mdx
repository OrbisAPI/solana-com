...
initialmente aggiunti al saldo in sospeso confidenziale. Prima che i token
...
Per convertire un saldo in sospeso in un saldo disponibile, richiamare
l'istruzione
...
transazione con l'istruzione `ApplyPendingBalance`, come illustrato nell'
esempio seguente.

### Codice di esempio

Il seguente esempio mostra come applicare il saldo in sospeso confidenziale al
saldo disponibile confidenziale.
